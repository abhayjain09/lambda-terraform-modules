...
variable "description" {
    type        = string
    default     = null
    description = "The short description of the Lambda function."
}
...
variable "enable_cloudwatchevent_trigger" {
  type = bool
  default = false
  description = "Cloudwatch event trigger"
...
locals {
  ...
  tags                    = merge(var.tags, { "ops/managed-by" = "terraform", Name = var.name })
}
